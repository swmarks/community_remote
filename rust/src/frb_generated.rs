...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1814639562;
...
fn wire__crate__api__simple__change_settings_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_repeat =
                <Option<crate::api::roon_transport_mirror::Repeat>>::sse_decode(&mut deserializer);
            let api_shuffle = <Option<bool>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::simple::change_settings(api_repeat, api_shuffle).await;
                        })?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn wire__crate__api__simple__get_server_properties_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "get_server_properties",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
...
fn wire__crate__api__simple__seek_zone_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_seconds = <i32>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::simple::seek_zone(api_seconds).await;
                        })?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn wire__crate__api__simple__set_status_message_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::simple::set_status_message(api_message).await;
                        })?;
                        Ok(output_ok)
                    })()
                    .await,
...
impl SseDecode for Option<crate::api::roon_transport_mirror::Repeat> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        if (<bool>::sse_decode(deserializer)) {
            return Some(<crate::api::roon_transport_mirror::Repeat>::sse_decode(
                deserializer,
            ));
        } else {
            return None;
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            0 => {
                ...
                return crate::api::simple::RoonEvent::CoreDiscovered(var_field0, var_field1);
            }
            1 => {
                let mut var_field0 = <String>::sse_decode(deserializer);
                let mut var_field1 = <String>::sse_decode(deserializer);
                return crate::api::simple::RoonEvent::CoreRegistered(var_field0, var_field1);
            }
            2 => {
                let mut var_field0 = <String>::sse_decode(deserializer);
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__simple__change_settings_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__simple__change_volume_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__simple__change_zone_volume_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__simple__control_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__simple__control_by_zone_id_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__simple__get_about_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__simple__get_image_impl(port, ptr, rust_vec_len, data_len),
        12 => {
            wire__crate__api__simple__get_server_properties_impl(port, ptr, rust_vec_len, data_len)
        }
        13 => wire__crate__api__simple__get_thumbnail_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__simple__group_outputs_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__simple__mute_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__simple__mute_all_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__simple__mute_zone_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__simple__pause_after_queue_items_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__simple__pause_all_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__simple__pause_on_track_end_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__simple__save_settings_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__simple__search_artist_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__simple__seek_zone_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__simple__select_browse_item_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__simple__select_queue_item_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__simple__select_zone_impl(port, ptr, rust_vec_len, data_len),
        28 => {
            wire__crate__api__simple__set_server_properties_impl(port, ptr, rust_vec_len, data_len)
        }
        29 => wire__crate__api__simple__set_status_message_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__simple__standby_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__simple__start_roon_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__simple__transfer_from_zone_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::simple::RoonEvent {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            crate::api::simple::RoonEvent::CoreDiscovered(field0, field1) => [
                0.into_dart(),
                field0.into_into_dart().into_dart(),
                field1.into_into_dart().into_dart(),
            ]
            .into_dart(),
            crate::api::simple::RoonEvent::CoreRegistered(field0, field1) => [
                1.into_dart(),
                field0.into_into_dart().into_dart(),
                field1.into_into_dart().into_dart(),
            ]
...
impl SseEncode for Option<crate::api::roon_transport_mirror::Repeat> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <bool>::sse_encode(self.is_some(), serializer);
        if let Some(value) = self {
            <crate::api::roon_transport_mirror::Repeat>::sse_encode(value, serializer);
        }
    }
}
