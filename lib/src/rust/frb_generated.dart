...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1814639562;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiSimpleChangeSettings({Repeat? repeat, bool? shuffle});
  ...
  Future<void> crateApiSimpleGetAbout();

  Future<void> crateApiSimpleGetImage({required String imageKey});

  Future<(String, String)?> crateApiSimpleGetServerProperties();

  Future<void> crateApiSimpleGetThumbnail({required String imageKey});
  ...
  Future<void> crateApiSimpleSeekZone({required int seconds});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiSimpleChangeSettings({Repeat? repeat, bool? shuffle}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_opt_box_autoadd_repeat(repeat, serializer);
        sse_encode_opt_box_autoadd_bool(shuffle, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 5, port: port_);
      },
      codec: SseCodec(
      ...
      constMeta: kCrateApiSimpleChangeSettingsConstMeta,
      argValues: [repeat, shuffle],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleChangeSettingsConstMeta =>
      const TaskConstMeta(
        debugName: "change_settings",
  ...
  Future<void> crateApiSimpleGetAbout() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSimpleGetAboutConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleGetAboutConstMeta => const TaskConstMeta(
        debugName: "get_about",
        argNames: [],
      );
  ...
  Future<(String, String)?> crateApiSimpleGetServerProperties() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSimpleGetServerPropertiesConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleGetServerPropertiesConstMeta =>
      const TaskConstMeta(
        debugName: "get_server_properties",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiSimpleGetThumbnailConstMeta => const TaskConstMeta(
        debugName: "get_thumbnail",
        argNames: ["imageKey"],
      );
  ...
  Future<void> crateApiSimpleSeekZone({required int seconds}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_i_32(seconds, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiSimpleSeekZoneConstMeta,
      argValues: [seconds],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleSeekZoneConstMeta => const TaskConstMeta(
        debugName: "seek_zone",
        argNames: ["seconds"],
      );
  ...
  @protected
  Repeat dco_decode_box_autoadd_repeat(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_repeat(raw);
  }
  ...
  @protected
  Repeat? dco_decode_opt_box_autoadd_repeat(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_repeat(raw);
  }
  ...
  RoonEvent dco_decode_roon_event(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return RoonEvent_CoreDiscovered(
          dco_decode_String(raw[1]),
          dco_decode_opt_String(raw[2]),
        );
      case 1:
        return RoonEvent_CoreRegistered(
          dco_decode_String(raw[1]),
      ...
      case 10:
        return const RoonEvent_BrowseReset();
      case 11:
      ...
      case 15:
        return const RoonEvent_SettingsSaved();
      case 16:
  ...
  @protected
  Repeat sse_decode_box_autoadd_repeat(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_repeat(deserializer));
  }
  ...
  @protected
  Repeat? sse_decode_opt_box_autoadd_repeat(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_repeat(deserializer));
    } else {
      return null;
    }
  }
  ...
  RoonEvent sse_decode_roon_event(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        return RoonEvent_CoreDiscovered(var_field0, var_field1);
      case 1:
        var var_field0 = sse_decode_String(deserializer);
        var var_field1 = sse_decode_String(deserializer);
  ...
  @protected
  void sse_encode_box_autoadd_repeat(Repeat self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_repeat(self, serializer);
  }
  ...
  @protected
  void sse_encode_opt_box_autoadd_repeat(
      Repeat? self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_repeat(self, serializer);
    }
  }
  ...
  void sse_encode_roon_event(RoonEvent self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case RoonEvent_CoreDiscovered(field0: final field0, field1: final field1):
        sse_encode_i_32(0, serializer);
        sse_encode_String(field0, serializer);
        sse_encode_opt_String(field1, serializer);
      case RoonEvent_CoreRegistered(field0: final field0, field1: final field1):
